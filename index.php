...
<head>
  ...
  <link rel="stylesheet" id="patternfly-adjusted-css" href="./app.css"
...
<body class="home page page-id-194 page-template page-template-page-homepage page-template-page-homepage-php custom-background" ondragstart="window.event.returnValue=false" oncontextmenu="window.event.returnValue=false" onselectstart="event.returnValue=false">
        ...
        <div class="navbar-collapse collapse">
          <ul id="menu-primary" class="nav navbar-nav navbar-right">
            ...
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown">
              <a href="http://wpa.qq.com/msgrd?v=3&uin=946120796&site=qq&menu=yes" class="dropdown-toggle">
               凌云
              </a>
            </li>            
  ...
  <div class="jumbotron">
    <div class="container">
      <div class="splash">
        <div class="content">
          <img src="http://q.qlogo.cn/headimg_dl?dst_uin=946120796&spec=640" alt="PatternFly logo" id="qq" class="wow fadeInDown animated"
          ...
          <h1 class="wow fadeIn animated" data-wow-delay="750ms" style="visibility: visible; animation-delay: 750ms; animation-name: fadeIn;">
            只有凌云不想做的<br/>没有凌云做不到的
          </h1>
          <p class="description wow fadeIn animated" data-wow-delay="1250ms" style="visibility: visible; animation-delay: 1250ms; animation-name: fadeIn;"></p>
<a href="./yanhua" class="button button-glow button-border button-rounded button-primary"><i class="fa fa-cloud"></i>烟花</a>

<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		  <div style="width: 100%;bottom: 30px;box-sizing: border-box;left: 100;">© 2020 by 凌云 </div>
        </div>
      </div>
    </div>
